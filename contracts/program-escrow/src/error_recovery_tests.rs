...
fn test_batch_result_partial_success() {
    ...
    // 2 failures
    result.record_failure(3, recipient.clone(), 100, RecoveryError::NetworkTimeout, &env);
    result.record_failure(4, recipient.clone(), 200, RecoveryError::InvalidRecipient, &env);
...
fn test_batch_result_complete_failure() {
    ...
    result.record_failure(0, recipient.clone(), 100, RecoveryError::NetworkTimeout, &env);
    result.record_failure(1, recipient.clone(), 200, RecoveryError::NetworkTimeout, &env);
    result.record_failure(2, recipient.clone(), 300, RecoveryError::NetworkTimeout, &env);
